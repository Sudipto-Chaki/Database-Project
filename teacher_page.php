	...
	<div class="main_wrapper">
		...
		<div class="content_wrapper">
			...
			<div id="sidebar">
				...
				<div id="sidebar_title">Access</div>
				<ul id="cats">
				...
				<ul id="cats">
					...
					<li><a href="teacher_publication.php">Click Here</a></li>
				
				</ul>
				
				<div id="sidebar_title">Courses</div>
				<ul id="cats">
				
					<li><a href="teacher_course.php">Click Here</a></li>
