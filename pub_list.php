...
<body>
	...
	<div class="main_wrapper">
		...
		<div class="content_wrapper">
			...
			<div id="content_area" style="height:800px">
				...
				<h1 align="center" style="padding-top:5px"><b>Publication List<hr></b></h1><br>
				<!--1st row starts-->
	...
	<?php	
	global $con;
	$get_not = "select * from publication order by pid desc";
	$run_not = mysqli_query($con, $get_not);
	while($row_not=mysqli_fetch_array($run_not)){
		
		$not_id=$row_not['type'];
		$not_title=$row_not['details'];
		$not_image=$row_not['year'];
		
		
		echo "
		<div>
		<ul>
		<li><b>Type: </b>$not_id</li><br>
		<li><strong>Details: </strong>$not_title</li><br>
		<li><strong>Year: </strong>$not_image</li><br>
		<hr>
